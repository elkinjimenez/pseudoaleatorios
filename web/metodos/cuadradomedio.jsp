<%-- 
    Document   : cuadradomedio
    Created on : 21/10/2019, 11:17:54 AM
    Author     : elomj
--%>
...
<html>
    <body>
        <div class="container-fluid">
            <h4 class="my-4 animated fadeInDown">Números aleatorios del <span class="font-weight-bold">método cuadrado medio</span></h4>
            <div class="table-responsive">
                <table class="table table-striped table-sm table-borderless table-hover">
                    <tr class="blue-text">
                        ...
                        <th class="font-weight-bold">X^2</th>
